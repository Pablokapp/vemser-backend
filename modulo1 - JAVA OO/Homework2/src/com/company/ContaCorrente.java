...
public class ContaCorrente extends Conta implements Impressao{
   private double chequeEspecial = 0.0;
    ...
    public ContaCorrente(String nome, String cpf, String telefone, String descricao, int tipo,double chequeEspecial, String numeroConta, String agencia, double saldo,
